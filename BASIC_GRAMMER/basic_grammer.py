...
# print(rand(1,46)) # 1 ~ 46 미만의 임의의 값 생성
...
# a =cycle("ABCD") # A B C D A B C D ...
# for d in a:
#         print(d)
# #cycle무한순회

# it = iter([1, 2, 3])  # [1, 2, 3]의 반복자 구하기
# next(it)              # 1, 반복자의 다음 요소 구하기1
# next(it)              # 2, 반복자의 다음 요소 구하기2
# next(it)              # 3, 반복자의 다음 요소 구하기3
# next(it)              # StopIteration더 구할 요소가 없으면 오류가 발생한다
